`ng-flex-layout` now supports server-side rendering (SSR). 

Developers should see the Universal Demo app source for details:

*  [main.server.ts](../../projects/apps/universal-demo-app/src/main.server.ts)
*  [app.routes.server.ts](../../projects/apps/universal-demo-app/src/app/app.routes.server.ts)
